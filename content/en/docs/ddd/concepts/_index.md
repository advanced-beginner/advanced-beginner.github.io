...
Starting from strategic design patterns and progressively moving to tactical design patterns is an effective learning sequence. [Strategic Design](strategic-design/) covers Subdomain, Bounded Context, Context Mapping, and Ubiquitous Language, while [Tactical Design](tactical-design/) teaches Entity, Value Object, Repository, Domain Service, and Specification patterns. [Aggregate Deep Dive](aggregate/) covers Aggregate design principles, transaction boundaries, and how to determine appropriate size, [Domain Events](architecture/event-driven/) explores event-driven architecture and Event Sourcing, and [Domain Model Patterns](domain-model-patterns/) covers auxiliary patterns like Specification, Policy, Module, Builder, and Null Object.
