...
> **선수 지식**: [histogram_quantile](../promql/histogram-quantile/)
> **소요 시간**: 약 20분
...
*99개 요청이 100ms인데 1개가 10초이면 평균은 199ms로 왜곡되지만, P99는 최악 경험을 정확히 반영함을 보여줍니다.*
...
*P99 증가 시 병목 구간(앱 내부, DB, 외부 API, 네트워크)에 따라 다른 개선 전략을 선택하는 의사결정 흐름입니다.*
