...
→ [Transformation과 Action]({{< relref "/docs/spark/concepts/transformations-actions" >}})

**Application**

사용자가 제출한 Spark 프로그램. [Driver](#driver)와 [Executor](#executor)로 구성된다.
→ [아키텍처]({{< relref "/docs/spark/concepts/architecture" >}})

**Block Manager**

[Executor](#executor) 내에서 캐시된 데이터와 셔플 데이터를 관리하는 컴포넌트. 메모리와 디스크 저장을 담당한다.
→ [아키텍처]({{< relref "/docs/spark/concepts/architecture" >}}), [캐싱과 영속성]({{< relref "/docs/spark/concepts/caching" >}})

**Broadcast Variable**

모든 노드에 읽기 전용으로 배포되는 공유 변수. 작은 데이터셋을 효율적으로 공유할 때 사용한다.
→ [성능 튜닝]({{< relref "/docs/spark/concepts/tuning" >}})

**Bucketing**

조인 최적화를 위해 동일한 키의 데이터를 같은 버킷에 저장하는 기법. 조인 시 [Shuffle](#shuffle) 회피 가능.
→ [파티셔닝과 셔플]({{< relref "/docs/spark/concepts/partitioning" >}})
...
→ [캐싱과 영속성]({{< relref "/docs/spark/concepts/caching" >}})

**Client Mode**

[Driver](#driver)가 클라이언트(spark-submit 실행 위치)에서 실행되는 배포 모드. 개발/디버깅에 적합.
→ [아키텍처]({{< relref "/docs/spark/concepts/architecture" >}}), [배포와 클러스터 관리]({{< relref "/docs/spark/concepts/deployment" >}})
...
→ [DataFrame과 Dataset]({{< relref "/docs/spark/concepts/dataframe-dataset" >}})
...
→ [배포와 클러스터 관리]({{< relref "/docs/spark/concepts/deployment" >}})
...
→ [RDD 기초]({{< relref "/docs/spark/concepts/rdd" >}})
...
→ [아키텍처]({{< relref "/docs/spark/concepts/architecture" >}}), [성능 튜닝]({{< relref "/docs/spark/concepts/tuning" >}})

**Parquet**

컬럼 기반 저장 포맷. 압축 효율이 높고 [Column Pruning](#column-pruning)을 지원하여 Spark에서 권장.
→ [DataFrame과 Dataset]({{< relref "/docs/spark/concepts/dataframe-dataset" >}}), [성능 튜닝]({{< relref "/docs/spark/concepts/tuning" >}})
...
→ [Quick Start]({{< relref "/docs/spark/quick-start" >}}), [아키텍처]({{< relref "/docs/spark/concepts/architecture" >}})
...
→ [성능 튜닝]({{< relref "/docs/spark/concepts/tuning" >}}), [배포와 클러스터 관리]({{< relref "/docs/spark/concepts/deployment" >}})
