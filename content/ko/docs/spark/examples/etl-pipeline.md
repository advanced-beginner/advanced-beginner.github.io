...
{{< callout type="info" title="핵심 포인트: 기본 ETL 구조" >}}
...
{{< callout type="info" title="핵심 포인트: 매출 데이터 ETL" >}}
...
{{< callout type="info" title="핵심 포인트: 데이터 정제 유틸리티" >}}
...
{{< callout type="info" title="핵심 포인트: 에러 처리 및 재시도" >}}
