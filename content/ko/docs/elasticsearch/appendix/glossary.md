---
title: 용어 사전
description: "Elasticsearch 핵심 용어를 정리합니다."
weight: 1
lastmod: 2026-01-15
---
...
Elasticsearch 핵심 용어를 빠르게 찾아볼 수 있습니다. 상세 설명은 [개념 이해]({{< relref "/docs/elasticsearch/concepts" >}}) 섹션을 참고하세요.

## A-E

### Aggregation (집계)
검색 결과를 그룹화하고 통계를 계산하는 기능. SQL의 `GROUP BY`와 유사. Bucket/Metric/Pipeline 세 종류.
→ [집계 개념]({{< relref "/docs/elasticsearch/concepts/aggregations" >}}) | [Query DSL]({{< relref "/docs/elasticsearch/concepts/query-dsl" >}})

### Alias (별칭)
[Index](#index-인덱스)에 부여하는 별명. 무중단 인덱스 전환, 멀티 인덱스 검색에 유용. [ILM](#ilm-index-lifecycle-management)과 함께 사용.
→ [인덱싱 전략]({{< relref "/docs/elasticsearch/concepts/indexing" >}})

### Analyzer (분석기)
텍스트를 [Term](#term)으로 분해하는 컴포넌트. Character Filter → [Tokenizer](#tokenizer) → Token Filter 순서로 처리. 한글에는 [Nori](#nori) 분석기 사용.
→ [데이터 모델링]({{< relref "/docs/elasticsearch/concepts/data-modeling" >}}) | [한글 검색]({{< relref "/docs/elasticsearch/concepts/korean-search" >}})

### Apache Lucene
Elasticsearch 내부에서 사용하는 오픈소스 검색 엔진 라이브러리. 각 [Shard](#shard-샤드)가 하나의 Lucene 인덱스.
→ [핵심 구성요소]({{< relref "/docs/elasticsearch/concepts/core-components" >}})

### Auto-Expand Replicas
[Node](#node-노드) 수에 따라 [Replica](#replica-shard) 수를 자동 조정하는 설정. `0-2` 형식으로 최소-최대 지정.
→ [고가용성]({{< relref "/docs/elasticsearch/concepts/high-availability" >}})
...
→ [검색 관련성]({{< relref "/docs/elasticsearch/concepts/search-relevance" >}})
...
→ [집계 개념]({{< relref "/docs/elasticsearch/concepts/aggregations" >}})
...
→ [데이터 모델링]({{< relref "/docs/elasticsearch/concepts/data-modeling" >}})

### Cluster (클러스터)
하나 이상의 [Node](#node-노드)로 구성된 Elasticsearch 서버 그룹. [Master Node](#master-node)가 상태 관리.
→ [핵심 구성요소]({{< relref "/docs/elasticsearch/concepts/core-components" >}}) | [클러스터 관리]({{< relref "/docs/elasticsearch/concepts/cluster-management" >}})

### Cluster Health
클러스터 전체 상태를 나타내는 지표. Green(정상), Yellow(Replica 미할당), Red(Primary 미할당).
→ [클러스터 관리]({{< relref "/docs/elasticsearch/concepts/cluster-management" >}})
...
→ [한글 검색]({{< relref "/docs/elasticsearch/concepts/korean-search" >}})
...
→ [클러스터 관리]({{< relref "/docs/elasticsearch/concepts/cluster-management" >}}) | [인덱싱 전략]({{< relref "/docs/elasticsearch/concepts/indexing" >}})
...
→ [성능 튜닝]({{< relref "/docs/elasticsearch/concepts/performance-tuning" >}})
...
→ [한글 검색 최적화]({{< relref "/docs/elasticsearch/concepts/korean-search" >}})
...
→ [인덱싱 전략]({{< relref "/docs/elasticsearch/concepts/indexing" >}}) | [성능 튜닝]({{< relref "/docs/elasticsearch/concepts/performance-tuning" >}})
...
→ [Query DSL]({{< relref "/docs/elasticsearch/concepts/query-dsl" >}}) | [집계]({{< relref "/docs/elasticsearch/concepts/aggregations" >}})
...
- [개념 이해]({{< relref "/docs/elasticsearch/concepts" >}}) - Elasticsearch 핵심 개념
- [Quick Start]({{< relref "/docs/elasticsearch/quick-start" >}}) - 빠른 시작 가이드
- [참고 자료]({{< relref "/docs/elasticsearch/appendix/references" >}}) - 공식 문서, 블로그
