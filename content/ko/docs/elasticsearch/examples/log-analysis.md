...
*Spring Boot 애플리케이션에서 Logback을 통해 Elasticsearch에 로그를 저장하고, Kibana 대시보드와 알림/모니터링으로 활용하는 전체 구조입니다.*
...
| 목표 | 추천 문서 |
|------|----------|
| 분산 로그 수집 | [분산 로그 수집 아키텍처](../../observability/concepts/log-aggregation/) |
