...
📖 [도메인 이벤트 상세](../concepts/architecture/event-driven/) | [Event Sourcing 실습](../examples/event-sourcing/)
...
📖 [계층형 아키텍처 상세](../concepts/architecture/layered-architecture/)
...
📖 [헥사고날 아키텍처 상세](../concepts/architecture/hexagonal-architecture/) | [Clean Architecture](../concepts/architecture/clean-architecture/)
...
📖 [헥사고날 아키텍처 상세](../concepts/architecture/hexagonal-architecture/#port)
...
📖 [헥사고날 아키텍처 상세](../concepts/architecture/hexagonal-architecture/#adapter)
...
📖 [클린 아키텍처 상세](../concepts/architecture/clean-architecture/)
...
📖 [어니언 아키텍처 상세](../concepts/architecture/onion-architecture/)
...
📖 [헥사고날 아키텍처](../concepts/architecture/hexagonal-architecture/) | [어니언 아키텍처](../concepts/architecture/onion-architecture/)
...
📖 [CQRS 상세](../concepts/architecture/cqrs/)
...
📖 [도메인 이벤트 상세](../concepts/architecture/event-driven/)
...
📖 [도메인 이벤트 상세](../concepts/architecture/event-driven/#saga)
