...
- [Aggregate 심화]({{< relref "/docs/ddd/concepts/aggregate" >}}) - 더 자세한 설계 원칙과 패턴
- [도메인 이벤트]({{< relref "/docs/ddd/concepts/architecture/event-driven" >}}) - Aggregate 간 통신 방법
- [주문 도메인 예제]({{< relref "/docs/ddd/examples/order-domain" >}}) - 실제 구현 예시
