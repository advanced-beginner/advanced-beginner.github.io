...
lastmod: "2026-01-15"
title: 매크로와 메타프로그래밍
description: "Scala 매크로와 메타프로그래밍의 작동 원리를 설명합니다."
weight: 15
---
...
타입 클래스 인스턴스를 수십 개의 케이스 클래스마다 수작업으로 작성해야 한다면? 또는 디버그 로깅을 릴리스 빌드에서 완전히 제거하고 싶다면? 메타프로그래밍은 반복적인 코드를 컴파일러가 대신 생성하고, 컴파일 타임에 검증까지 수행하여 런타임 오버헤드 없이 안전한 코드를 만들어 줍니다.
