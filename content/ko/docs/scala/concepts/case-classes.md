...
lastmod: "2026-01-15"
title: 케이스 클래스
description: "케이스 클래스의 작동 원리와 불변 데이터 모델링을 설명합니다."
weight: 5
---

## 전체 비유: 공식 서류 양식

케이스 클래스를 <strong>공식 서류 양식</strong>에 비유하면 이해하기 쉽습니다:
...
- 케이스 클래스는 <strong>불변 데이터 모델링</strong>을 위한 특별한 클래스입니다
...
Java에서 데이터를 담기 위한 클래스를 만들 때마다 생성자, getter, equals, hashCode, toString을 직접 작성해야 한다면? 케이스 클래스는 이 모든 보일러플레이트를 컴파일러가 자동 생성하여 데이터 모델링에만 집중할 수 있게 합니다.
