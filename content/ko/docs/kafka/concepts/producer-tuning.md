...
**선수 지식**: [심화 개념]({{< relref "/docs/kafka/concepts/advanced-concepts" >}})의 acks, Idempotent Producer, [메시지 흐름]({{< relref "/docs/kafka/concepts/message-flow" >}})의 Topic, Partition 개념
...
이 문서를 읽기 전에 [심화 개념]({{< relref "/docs/kafka/concepts/advanced-concepts" >}})에서 acks, Message Key, Idempotent Producer를, [메시지 흐름]({{< relref "/docs/kafka/concepts/message-flow" >}})에서 Topic, Partition, Broker 개념을 먼저 이해하고 있어야 합니다.
...
- [Consumer 심화 운영]({{< relref "/docs/kafka/concepts/consumer-advanced" >}}) - Consumer 성능 최적화
- [트랜잭션]({{< relref "/docs/kafka/concepts/transactions" >}}) - Exactly-Once 처리
