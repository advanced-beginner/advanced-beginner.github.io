...
**선수 지식**: [Consumer Group & Offset]({{< relref "/docs/kafka/concepts/consumer-group" >}})의 기본 개념, [Replication]({{< relref "/docs/kafka/concepts/replication" >}})의 ISR과 Leader 개념
...
이 문서를 읽기 전에 [Consumer Group & Offset]({{< relref "/docs/kafka/concepts/consumer-group" >}})에서 기본 개념을, [Replication]({{< relref "/docs/kafka/concepts/replication" >}})에서 ISR과 Leader 개념을 먼저 이해하고 있어야 합니다.
