...
**선수 지식**: [핵심 구성요소]({{< relref "/docs/kafka/concepts/core-components" >}})의 Broker, Partition 개념
...
- [심화 개념]({{< relref "/docs/kafka/concepts/advanced-concepts" >}}) - acks, Message Key, Retention, Idempotent Producer
