...
**선수 지식**: [Consumer Group & Offset]({{< relref "/docs/kafka/concepts/consumer-group" >}})의 Consumer 동작 원리
...
- [에러 처리 심화]({{< relref "/docs/kafka/concepts/error-handling" >}}) - 에러 처리 패턴과 Dead Letter Topic
