...
**선수 지식**: [핵심 구성요소]({{< relref "/docs/kafka/concepts/core-components" >}})의 Topic, Producer, Consumer 개념, [메시지 흐름]({{< relref "/docs/kafka/concepts/message-flow" >}})의 전체 데이터 흐름
...
- [실습 예제]({{< relref "/docs/kafka/examples" >}}) - Kafka Connect, Schema Registry, Kafka Streams 실습
- [보안]({{< relref "/docs/kafka/concepts/security" >}}) - 생태계 컴포넌트의 보안 설정
- [모니터링]({{< relref "/docs/kafka/concepts/monitoring" >}}) - Connect와 Streams 메트릭 모니터링
