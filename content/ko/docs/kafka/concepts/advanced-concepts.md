...
acks는 Producer가 메시지 전송 성공을 어떻게 확인할지 결정하는 설정입니다. 이를 **등기우편 발송**에 비유하면 이해하기 쉽습니다:
...
Message Key는 메시지를 특정 Partition으로 라우팅하는 데 사용됩니다. 이를 **호텔 투숙객 관리**에 비유하면:
...
Retention은 메시지를 얼마나 오래 보관할지 결정합니다. 이를 **서류 보관 정책**에 비유하면:
